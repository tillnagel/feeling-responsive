...
gallery:
    - image_url: {{ site.urlimg }}WAY/Gallery/way_Moditest.jpg"
       caption: TRYTRYCAPTIoN
---
...
Ein weiterer Aspekt des Konzeptes ist die Möglichkeit an Ort und Stelle kleine Nachrichten zu hinterlassen und Einzelnen oder der Allgemeinheit freizugebenen. Diese können in Text, Bild und Ton z. B. Eindrücke teilen, die man auf dem Weg gesammelt hat, kleine Tipps, wo es sich lohnt mal die Augen oder die Ohren offen zu halten oder auch gemeinsame Erinnerungen, die mit bestimmten Orten und Strecken verbunden werden.
...
<a href="{{ site.urlimg }}/WAY/Gallery/way_proxemix.jpg">
  ...
  <figcaption>Überlegungen wie WAY über Stadtgrenzen hinaus zum Austausch dienen kann</figcaption>
</figure>
